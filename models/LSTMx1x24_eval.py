...
json_file=open('model_LSTM_1_24.json','r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("model_LSTM_1_24.h5")
...
#history=model.fit(X_train_indices, y_train, batch_size=50, epochs=1, validation_split=0.3,verbose=2)


# In[28]:


loss, acc = loaded_model.evaluate(X_test_indices, y_test,verbose=2)
print()
print("Test accuracy = ", acc)
print("Test loss = ",loss)
# print out misclassification examples

labels=loaded_model.predict(X_test_indices, verbose=0)
...
#plt.ylabel('loss')
#plt.xlabel('epoch')
#plt.savefig('../outputs/training_LSTM_1x24.png')
